	...
	<div class="row">
		<div class="col-md-12">
			<c:forEach items="${listaVagas}" var="vaga">
				<h1>${vaga.titulo}</h1>
				<div class="action">
				<a href="vaga?acao=curtir&id=${vaga.id}"><span class="glyphicon glyphicon glyphicon-thumbs-up" aria-hidden="true"></span></a>
				...
				<h3 class="subtitle"><fmt:formatNumber value="${vaga.remuneracao}" type="currency" /> - ${vaga.like} Likes</h3>
				<hr>
			</c:forEach>
		</div>
	</div>    
